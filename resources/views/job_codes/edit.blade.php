<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-wrap items-start justify-between gap-2">
            <div>
                <h1 class="font-bold text-2xl text-gray-800 leading-tight">Edit Job Code</h1>
                <p class="text-sm text-gray-500 mt-1">Update the details of {{ $jobCode->job_code }}.</p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm rounded-2xl overflow-hidden">
                ...
                <form method="POST" action="{{ route('job-codes.update', $jobCode->id) }}">
                    @method('PUT')
