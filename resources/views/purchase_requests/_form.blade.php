...
<div class="p-6 sm:p-8 space-y-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1.5">Request No</label>
                <div class="relative">
                    ...
                    <input type="text" value="{{ $isEdit ? $purchaseRequest->no_request : $nextNoRequest }}" readonly tabindex="-1"
                ...
                <p class="mt-1.5 text-xs text-gray-400">Request No &amp; date are generated automatically.</p>
            </div>
            <div>
