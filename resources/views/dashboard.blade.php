        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
            ...
            <a href="{{ route('material-requests.index') }}" class="group block bg-white rounded-xl border border-gray-100 hover:border-indigo-200 shadow-sm hover:shadow transition p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    @if($mrTrend != 0)
                        <span class="inline-flex items-center gap-0.5 text-xs font-semibold {{ $mrTrend >= 0 ? 'text-green-600 bg-green-50' : 'text-red-500 bg-red-50' }} px-2 py-0.5 rounded-full">
                    ...
                    @else
                        <span class="text-xs font-medium text-gray-400 bg-gray-50 px-2 py-0.5 rounded-full">— 0%</span>
                    @endif
                </div>
            ...
            <a href="{{ route('rlps.index') }}" class="group block bg-white rounded-xl border border-gray-100 hover:border-purple-200 shadow-sm hover:shadow transition p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    @if($rlpTrend != 0)
                        <span class="inline-flex items-center gap-0.5 text-xs font-semibold {{ $rlpTrend >= 0 ? 'text-green-600 bg-green-50' : 'text-red-500 bg-red-50' }} px-2 py-0.5 rounded-full">
                            <svg class="w-3 h-3 {{ $rlpTrend < 0 ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/>
                            </svg>
                            {{ abs($rlpTrend) }}% bln ini
                        </span>
                    @else
                        <span class="text-xs font-medium text-gray-400 bg-gray-50 px-2 py-0.5 rounded-full">— 0%</span>
                    @endif
            ...
            <a href="{{ route('purchase-requests.index') }}" class="group block bg-white rounded-xl border border-gray-100 hover:border-amber-200 shadow-sm hover:shadow transition p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    @if($prTrend != 0)
                        <span class="inline-flex items-center gap-0.5 text-xs font-semibold {{ $prTrend >= 0 ? 'text-green-600 bg-green-50' : 'text-red-500 bg-red-50' }} px-2 py-0.5 rounded-full">
                            <svg class="w-3 h-3 {{ $prTrend < 0 ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/>
                            </svg>
                            {{ abs($prTrend) }}% bln ini
                        </span>
            ...
            <a href="{{ route('purchase-orders.index') }}" class="group block bg-white rounded-xl border border-gray-100 hover:border-emerald-200 shadow-sm hover:shadow transition p-5">
                <div class="flex items-center justify-between mb-3">
                    ...
                    @if($poTrend != 0)
                        <span class="inline-flex items-center gap-0.5 text-xs font-semibold {{ $poTrend >= 0 ? 'text-green-600 bg-green-50' : 'text-red-500 bg-red-50' }} px-2 py-0.5 rounded-full">
                            <svg class="w-3 h-3 {{ $poTrend < 0 ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7"/>
                            </svg>
                            {{ abs($poTrend) }}% bln ini
                        </span>
