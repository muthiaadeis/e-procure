    ...
    public function notifications()
    {
        ...
        foreach ($overdueMrs as $m) {
            $notifications[] = [
                ...
                'message' => 'Material request untuk ' . ($m->charge_to ?? 'proyek') . ' telah melebihi batas waktu.',
        ...
        foreach ($pendingRlps as $r) {
            $notifications[] = [
                ...
                'icon' => 'document',
                'title' => 'Local Purchase Baru: ' . ($r->no_rlp ?? 'RLP-' . $r->id),
                'message' => 'Membutuhkan review dan verifikasi dokumen.',
