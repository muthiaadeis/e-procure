...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'MR System') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center py-10 px-4 bg-gradient-to-br from-indigo-50 via-white to-rose-50 relative overflow-hidden">
            ...
            <div class="relative flex flex-col items-center mb-6">
                ...
                <h1 class="text-lg font-semibold text-gray-800">{{ config('app.name', 'MR System') }}</h1>
            ...
            <p class="relative mt-6 text-xs text-gray-400">&copy; {{ date('Y') }} {{ config('app.name', 'MR System') }}. All rights reserved.</p>
        </div>
    </body>
</html>
